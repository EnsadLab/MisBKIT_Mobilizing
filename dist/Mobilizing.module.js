import { Box3, BoxGeometry, CircleGeometry, Color, CubeReflectionMapping, CubeRefractionMapping, CubeUVReflectionMapping, CubeUVRefractionMapping, CylinderGeometry, EdgesGeometry, EquirectangularReflectionMapping, EquirectangularRefractionMapping, Euler, Face3, Font, Geometry, IcosahedronGeometry, Line, LineSegments, LinearFilter, LinearMipMapLinearFilter, Matrix3, Matrix4, Mesh, NearestFilter, Object3D, OctahedronGeometry, Path, PlaneBufferGeometry, Quaternion, RGBFormat, RepeatWrapping, Shape, ShapeGeometry, SphereGeometry, SphericalReflectionMapping, Sprite, TextGeometry, Texture, UVMapping, Vector2, Vector3, VertexColors, WebGLRenderTarget } from 'three';
...
Texture$1.UVMapping = UVMapping;
Texture$1.CubeReflectionMapping = CubeReflectionMapping;
Texture$1.CubeRefractionMapping = CubeRefractionMapping;
Texture$1.EquirectangularReflectionMapping = EquirectangularReflectionMapping;
Texture$1.EquirectangularRefractionMapping = EquirectangularRefractionMapping;
Texture$1.SphericalReflectionMapping = SphericalReflectionMapping;
Texture$1.CubeUVReflectionMapping = CubeUVReflectionMapping;
Texture$1.CubeUVRefractionMapping = CubeUVRefractionMapping;
    ...
    createClass(Mesh$$1, [{
        ...
        */
        ...
        value: function constructLine(params) {
            ...
            this.mesh = new Line(this._geometry, this.material._material);
        }
        ...
        */
        ...
        value: function constructSprite() {
            ...
            this.mesh = new Sprite(this.material._material);
        }
        ...
        */
        ...
        value: function constructPlane(params) {
            ...
            this._geometry = new PlaneBufferGeometry(width, height, widthSegments, heightSegments);

            //manage the material according to the passed params, see the attachMaterial method below
            this.attachMaterial(this.material);

            this.mesh = new Mesh(this._geometry, this.material._material);
        }
        ...
        */
        ...
        value: function constructQuad(params) {
            ...
            this._geometry = new ShapeGeometry(rectShape);
        ...
        */
        ...
        value: function constructCube(params) {
            ...
            this._geometry = new BoxGeometry(size, size, size, widthSegments, heightSegments, depthSegments);
        ...
        */
        ...
        value: function constructBox(params) {
            ...
            this._geometry = new BoxGeometry(width, height, depth, widthSegments, heightSegments, depthSegments);
        ...
        */
        ...
        value: function constructSphere(params) {
            ...
            this._geometry = new SphereGeometry(radius, widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength);
            this._geometry.dynamic = true;
        ...
        */
        ...
        value: function constructCircle(params) {
            ...
            this._geometry = new CircleGeometry(radius, segments, thetaStart, thetaLength);
        ...
        */
        ...
        value: function constructCylinder(params) {
            ...
            this._geometry = new CylinderGeometry(radiusTop, radiusBottom, height, radiusSegments, heightSegments, openEnded, thetaStart, thetaLength);
        ...
        */
        ...
        value: function constructOctahedron(params) {
            ...
            this._geometry = new OctahedronGeometry(radius, detail);
            this._geometry.dynamic = true;
        ...
        */
        ...
        value: function constructText(params) {
            ...
            var threeFont = new Font(font);
            console.log(threeFont);

            this._geometry = new TextGeometry(text, { size: fontSize,
                height: height,
        ...
        */
        ...
        value: function constructCustom(params) {
            this._geometry = getOrDefault(params, "geometry", new Geometry());
            this._geometry.dynamic = true;
        }
        ...
        */
        ...
        value: function createLine(start, end, color, texture, width, uvScale) {
            ...
            var uv1 = new Vector2(0, uvScale);
            var uv2 = new Vector2(1, uvScale);
            var uv3 = new Vector2(1, 0);
            var uv4 = new Vector2(0, 0);
        ...
        */
        ...
        value: function pushFace(i1, i2, i3) {
            this._geometry.faces.push(new Face3(i1, i2, i3));
        ...
        */
        ...
        value: function pushTriangle(v1, v2, v3) {
            ...
            this._geometry.faces.push(new Face3(i + 0, i + 1, i + 2));
            this._geometry.verticesNeedUpdate = true;
            this._geometry.elementsNeedUpdate = true;
        }
        ...
        */
        ...
        value: function pushQuad(v1, v2, v3, v4, uv1, uv2, uv3, uv4) {
            ...
            this._geometry.faces.push(new Face3(i + 0, i + 1, i + 2));
            this._geometry.faces.push(new Face3(i + 0, i + 2, i + 3));
        ...
        */
        ...
        value: function setVertexColors(colors) {
            this.material._material.vertexColors = VertexColors;
        ...
        */
        ...
        value: function setMaterial(material) {
            ...
            var tempMesh = new Mesh(this._geometry, this.material._material);
...
var EdgesMesh = function (_Mesh) {
    ...
    function EdgesMesh(params) {
        ...
        if (_params.mesh) {
            ...
            _this.mesh = new LineSegments(new EdgesGeometry(_params.mesh.geometry, _params.threshold), _this.material._material);
            //console.log("tempMesh.geometry",_params.mesh);
        } else {
            _this.mesh = new LineSegments(new EdgesGeometry(_this._geometry, _params.threshold), _this.material._material);
        }
...
var OBJ = function () {
    ...
    createClass(OBJ, null, [{
        ...
        key: 'attachTexture',
        value: function attachTexture(loader, model, data) {
    ...
    */
    ...
    createClass(Context, [{
        ...
        */
        ...
        key: 'chainedCall',
        value: function chainedCall(component, method) {
...
var RenderTexture = function () {
    ...
    function RenderTexture(params) {
        ...
        this._engineTexture = new WebGLRenderTarget(this._width, this._height, { minFilter: LinearFilter,
    ...
    createClass(EasyContext, [{
        ...
        */
        ...
        value: function createTextureFromCubeCamera(camera) {
            ...
            texture.cube.minFilter = LinearMipMapLinearFilter;
            return texture;
        }
...
export { version, revision, input, net, GPSUtils, _Math as math, getOrDefault, AudioBuffer, AudioSource, Color$1 as Color, Euler$1 as Euler, Matrix3$1 as Matrix3, Matrix4$1 as Matrix4, Quaternion$1 as Quaternion, Rect, Vector2$1 as Vector2, Vector3$1 as Vector3, Animation, Csg, Debug, debug, Device, BatteryStatus, MeshFX, Midi, Profiler, Runner, Loader, Cache, Pointer, _DOM, PhysicsEngine, Engine3D, Renderer3D, RendererAudio, Camera, Font$1 as Font, Light, LODGroup, Material, Transform, Label, Mesh$1 as Mesh, EdgesMesh, StyledLetter, StyledTextElement, TextLine, RichText, CanvasTexture, DOMNodeTexture, ImageSequenceTexture, RenderTexture, Texture$1 as Texture, VideoTexture, Time, Timer, NTP, Button, ButtonGroup, Clickable, TextField, Context, EasyContext };
//# sourceMappingURL=Mobilizing.module.js.map
